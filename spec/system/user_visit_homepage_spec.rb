...
#Arrange
warehouses = []
warehouses << Warehouse.new(id: 1, name: "Aeroporto Rio", code: "RIO", city:"Rio de Janeiro",area:60000,address:"Av do Porto, 1000",cep:"20000-000",description:"Galpão Rio",state:"RJ")
